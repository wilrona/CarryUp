...
global_role = [
    {"module": "Panneau d'administration", "valeur": "panneau_admin",
     'role': [
         {
             'titre': 'Parametres',
             'valeur': 'parametre',
             'role': [
                  {
                      'titre': 'Parametre generale',
                      'valeur' : 'param_general'
                  },
                  {
                     'titre': 'Parametre Magasin',
                     'valeur' : 'param_magasin'
                  }
              ]
         },
         {
             ...
             'role': [
                 {
                     ...
                     'role': [
                         {
                            'titre' : 'edition des employes',
                             'valeur': 'employe_edit',
                         },
                         {
                             'titre': 'Activation des employes',
                             'valeur': 'employe_active'
                         }
                     ]
                 }
             ]
...
global_composant = {
    'moule' : 'Moules',
    'fourage' : 'Fourage',
    'gout_creme' : 'Gout de gout creme',
    'imbibage' : 'Imbibage',
    'coulis' : 'Coulis',
    'topping' : 'Topping',
    'couleur_cup' : 'Couleur cupcake',
    'ruban' : 'Couleur de ruban',
    'type_gateau' : 'Type de gateau',
    'forme_sable': 'Forme sable',
    'categorie': 'Categorie de gateau'
}
