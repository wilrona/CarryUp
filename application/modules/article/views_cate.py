...
def index():
    ...
    return render_template('categorie/categorie/index.html', **locals())
...
def edit(data_id=None):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('cat.index'))

    return render_template('categorie/categorie/edit.html', **locals())
