...
prefix = Blueprint('groupe_client', __name__)
...
def index():
    ...
    return render_template('categorie/groupe/index.html', **locals())
...
def edit(data_id=None):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('groupe_client.index'))

    return render_template('categorie/groupe/edit.html', **locals())
