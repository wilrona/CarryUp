  ...
  fetchCheck = (datajson) => {
    ...
    .then(data => {
      ...
      if(!$.isEmptyObject(data)){
        ...
        newState.data.prix_achat = data.prix_achat
      ...
      if(datajson.select === true){
        this.$achat.val(data.prix_achat)
      }
      ...
      this.setState(newState, () => {
        if (this.props.action === 'add' && !$.isEmptyObject(data)){
          ...
          this.props.updateData(this.props.index, data.prix_achat, 'prix_achat')
  ...
  update = (e, index) => {
    ...
    if(this.state.data.id === null || this.state.data.name === null){
      ...
      if(this.state.data.quantite === 0){
        ...
        if(this.state.data.prix_achat === 0){
          swal({
              title: 'Prix d\'achat indefini.',
              text: 'La valeur doit etre superieur a zero ',
              type: 'error'
          });
        }else{
              ...
              <tbody>
                  <tr>
                    ...
                    <td className="text-right" style={{ width:'20%' }}>
                          ...
                          <input type="text" name="prix_achat" ref={el => this.achat = el} defaultValue={this.state.data.prix_achat} className="form-control text-right" data-a-sep=" " data-v-min="0" data-v-max="999999999999" />
