            ...
            <div>
                <div className="card-header">
                    <div className="card-title col-md-8">
                        <a href={this.props.linkEdit} className="btn btn-primary btn-sm">Creer un bon de commande</a>
                    </div>
...
const domContainer = document.getElementById('card_bcmd');
