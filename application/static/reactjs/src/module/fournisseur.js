            ...
            <div>
                <div className="card-header">
                    <div className="card-title col-md-8">
                        <a href={this.props.linkEdit} className="btn btn-primary btn-sm">Creer un fournisseur</a>
                    </div>
...
const domContainer = document.getElementById('card_fournisseur');
...
if (domContainer){
    ...
    render(
        <Fournisseurs linkEdit={edit} linkList={list}/>,
        domContainer
    );
