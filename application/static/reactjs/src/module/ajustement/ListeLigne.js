...
class ListeLigne extends Component {
      ...
      componentDidMount = () => {
        ...
        const motif = document.getElementById('etat');
        const react = this;
        ...
        $(motif).on('change', function(e){
              ...
              if($(this).val() !== ''){
                ...
                if(currentData.length > 0){
                  swal({
                      title: 'Les articles seront supprimes.',
                      text: 'l\'ensemble des articles deja selectionne sera supprime du systeme',
                      type: 'warning',
                      showCancelButton: true,
                      cancelButtonText: 'Annuler',
                      showConfirmButton: true,
      ...
      */
      ...
      addData = (e) => {
        ...
        if($(magasin_origine).val().length == 0){

          swal({
              title: 'Point de vente non defini.',
              text: 'Point de vente d\'origine obligatoires',
              type: 'warning'
          })

        }else{

          if($(motif).val().length == 0){
            swal({
                title: 'Motif non defini.',
                text: 'Motif d\'ajustement obligatoires',
                type: 'warning'
            })
          }else{
                      ...
                      <table className="table table-condensed">
                        <thead>
                          <tr>
                            ...
                            <th className="text-right"  style={{ width:'20%' }}>Rajustement</th>
                            <th className="text-right"  style={{ width:'20%' }}>Nouveau stock</th>
...
const domContainer = document.getElementById('card_ligneAjustement');
