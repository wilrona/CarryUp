...
class LigneItem extends Component {
  ...
  componentDidMount = () => {
    ...
    if(this.props.motif == 0 || this.props.motif == 1){
              ...
              <tbody>
                  <tr>
                    ...
                    <td className="text-right" style={{ width:'20%' }}>
                        ...
                        <input type="text" name="prix_achat" ref={el => this.quantite = el} defaultValue={this.state.data.quantite} className="form-control text-right" data-a-sep=" " />

                    </td>
                    <td className="text-right" style={{ width:'20%' }}>
                        {this.props.motif != 1 ? this.state.data.stock + this.state.data.quantite ? this.state.data.stock + this.state.data.quantite : 0 : this.state.data.quantite}
                    </td>
