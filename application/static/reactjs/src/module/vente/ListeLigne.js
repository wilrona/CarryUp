          ...
          if($(this).val() !== ''){
            ...
            if(alert == true){
              ...
              if (currentData.length){
                swal({
                    title: 'Suppression des articles de la liste.',
                    text: 'L\'ensemble des articles deja traite seront supprime',
                    type: 'warning',
                    showCancelButton: true,
                    cancelButtonText: 'Annuler',
                    showConfirmButton: true,
      ...
      */
      ...
      addData = (e) => {
        ...
        if($(magasin).val().length == 0){
          ...
          let newState =  Object.assign({}, this.state);
          newState.structureItem = [{ id: null, name: "", quantite : 0, prix_vente: 0, montant: 0, magasin: []}]
          newState.currentUpdateItem = null
                      ...
                      <table className="table table-condensed">
                        <thead>
                          <tr>
                            ...
                            <th className="text-right"  style={{ width:'20%' }}>Prix vente</th>
...
const domContainer = document.getElementById('card_ligneVente');
