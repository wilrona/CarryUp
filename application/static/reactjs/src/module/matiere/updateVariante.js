                                ...
                                return (
                                  ...
                                  <div key={index_data}>
                                        ...
                                        <div className="checkbox check-success">
                                            ...
                                            <label htmlFor={index_data}>disponible au { magSyst.mag_name }</label>
                                        </div>
                                        ...
                                        <div className='form-table form-table--with-spacing'>
                                            ...
                                            <div className="form-group row">
                                                <label className='col-md-3 control-label form-field__label'>Stock conditionne</label>
                                                <div className="col-md-9 form-field__content">
                                                        <span className="form-link--with-spacing">{magSyst.stock_conditionne} {this.state.currentVariante.unite}</span>
                                                </div>
                                            </div>
                                            <div className="form-group row">
