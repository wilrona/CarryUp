...
class ArticleAssocie extends Component {
      ...
      */
      ...
      addMatiere = (e) => {
        e.preventDefault()
        let newState =  Object.assign({}, this.state);
        newState.structureItem = [{ id: null, name: null, quantite : 0, type_article : null}]
        newState.currentUpdateItem = null
        this.setState(newState)
        ...
        return (
          <div>
              <div className="lead m-b-20 m-t-50">
                  Articles associes
                  <p>
                    <small>La vente de cet article va consommer n (quantite) fois chacune des articles ou recettes associe(e)s</small> <br />
                    <small>Cette section ne sera pas pris en compte si l'article est un produit semi-fini</small> <br />
                    <small>Un produit possedant des articles associes ne peut etre associe dans un autre article</small>
                  </p>
              </div>
              ...
              {(this.state.matieres.length !== 0 || this.state.structureItem.length !== 0) && (
                ...
                <div className="mh-370">
                      <table className="table table-condensed">
                        <thead>
                          <tr>
                            <th style={{width:'70%'}}>Articles/Recettes</th>
                        ...
                        <div className="form-group row">
                            <div className="col-md-12 form-field__content" >
                                  <a className="form-link--with-spacing" hidden={this.state.structureUpdated === true} href="#" onClick={(event) => this.addMatiere(event)}>Ajouter un article</a>
...
const domContainer = document.getElementById('card_articleAssocie');
...
if (domContainer){
    ...
    render(
        <ArticleAssocie id={id} urlVariante={urlVariante} urlAllMatiere={urlAllMatiere} urlCheck={urlCheck} setContent={setContent}/>,
        domContainer
    );
